...
func makeReadme(filename string) error {
	fp := gofeed.NewParser()
	feed, err := fp.ParseURL("https://blog.kaiiyer.ninja/rss.xml")
	if err != nil {
	...
	blog := "\n\n  <img src='https://media.giphy.com/media/dlMIwDQAxXn1K/giphy.gif' alt='You found me!' width='50%' align='right'/> \n\n✨ I’m an Infosec developer :zap: I love breaking the limits with smart work. <img src='https://media.giphy.com/media/dlMIwDQAxXn1K/giphy.gif' alt='You found me!' align='right'/> \n\n - 🌱 I attend **hackathons** and speak about trending technologies.\n\n - ⭐️ I use: `.py`, `.go`, `.c`, `.js`, `.html`, `.scss`, `.json`, `.yml` \n\n - 💜 Interests: Anime & Cyber \n\n - 😄 I'm Kai Iyer in Japan & NetworkOverclocker in Canada. \n\n - This " + whoList[who] + " says they " + whatList[what] + " my latest blog post: **[" + blogItem.Title + "](" + blogItem.Link + ")**"
